(function ($) {
    ...
    var settings = {
            ...
            topOptionText: switchTopOptionText()	//default "unselected" state
        },
    ...
    //switch language
    function switchTopOptionText() {

        var topOptionTextLocal = '';

        if ($('html').attr('lang') === 'zh-CN') {
            topOptionTextLocal = "请选择页面：";
        } else {
            topOptionTextLocal = "Select a page:";
        }
        return topOptionTextLocal;
    }
